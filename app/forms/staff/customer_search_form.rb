class Staff::CustomerSearchForm
  ...
  def search
    ...
    rel = rel.where('phones.number_for_index' => phone_number) if phone_number.present?
    rel = rel.where('phones.last_four_digits' => last_four_digits) if last_four_digits.present?
